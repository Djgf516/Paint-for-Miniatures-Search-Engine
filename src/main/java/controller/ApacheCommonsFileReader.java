...
//    }
//
//    // Replace the value if found within the line.
//
//    // Replace the value if found within the line.
...
//                int index = line.indexOf(paintName);
//                if (index != -1) {
//                    String replacement = String.valueOf(currentPaint.getPaintId());
//                    line = line.substring(0, index) + replacement + line.substring(index + paintName.length());
//                }
//            }
//        }
//        return line;
